...
SimpleForm.setup do |config|
  ...
  config.wrappers :nested_form, tag: 'div', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :inline_boolean, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrapper_mappings = {
    ...
    has_feedback_string: :has_feedback,
