...
# Turbolinks has been disabled, since it conflicts with (at least) the vertical nav. of PatternFly
#gem 'turbolinks', '~> 5'
...
group :development, :test do
  ...
  gem 'rspec-rails'
  gem 'factory_bot_rails' # framework and DSL for defining and using factories
end
