...
RSpec.describe PatternFlyHelper, type: :helper do
  ...
  describe '#pf_toast_notification' do
    subject       { helper.pf_toast_notification }
    let(:content) { 'Lorem' }

    context 'success' do
      before { flash[:success] = content }

      it { is_expected.to have_css('div.toast-pf.toast-pf-max-width.toast-pf-top-right.alert.alert-success.alert-dismissable', text: content) }
      it { is_expected.to have_css('div.alert span.pficon.pficon-ok') }
      it { is_expected.to have_css('div.alert button.close[data-dismiss="alert"] span.pficon.pficon-close') }
    end
    ...
    context 'info' do
      ...
      it { is_expected.to have_css('div.toast-pf.toast-pf-max-width.toast-pf-top-right.alert.alert-info.alert-dismissable', text: content) }
      it { is_expected.to have_css('div.alert span.pficon.pficon-info') }
      it { is_expected.to have_css('div.alert button.close[data-dismiss="alert"] span.pficon.pficon-close') }
    end
    ...
    context 'warning' do
      ...
      it { is_expected.to have_css('div.toast-pf.toast-pf-max-width.toast-pf-top-right.alert.alert-warning.alert-dismissable', text: content) }
      it { is_expected.to have_css('div.alert span.pficon.pficon-warning-triangle-o') }
      it { is_expected.to have_css('div.alert button.close[data-dismiss="alert"] span.pficon.pficon-close') }
    end
    ...
    context 'danger' do
      ...
      it { is_expected.to have_css('div.toast-pf.toast-pf-max-width.toast-pf-top-right.alert.alert-danger.alert-dismissable', text: content) }
      it { is_expected.to have_css('div.alert span.pficon.pficon-error-circle-o') }
      it { is_expected.to have_css('div.alert button.close[data-dismiss="alert"] span.pficon.pficon-close') }
    end
    ...
    context 'with options passed' do
      before          { flash[:success] = content }
      subject         { helper.pf_toast_notification options }
      let(:classname) { 'my-classname' }
      let(:options)   { { class: classname } }

      it { is_expected.to have_css('div.toast-pf.toast-pf-max-width.toast-pf-top-right.alert.alert-success.alert-dismissable.my-classname', text: content) }
      it { is_expected.to have_css('div.alert span.pficon.pficon-ok') }
      it { is_expected.to have_css('div.alert button.close[data-dismiss="alert"] span.pficon.pficon-close') }
    end
    ...
    context 'multiple flashes' do
      ...
      it { is_expected.to have_css('div.toast-pf.toast-pf-max-width.toast-pf-top-right.alert.alert-success.alert-dismissable', text: content1) }
      it { is_expected.to have_css('div.toast-pf.toast-pf-max-width.toast-pf-top-right.alert.alert-info.alert-dismissable', text: content2) }
      it { is_expected.to have_css('div.alert button.close[data-dismiss="alert"] span.pficon.pficon-close', count: 2) }
    end
  end
end
